...
<main className="py-6 px-4 sm:p-6 md:py-10 md:px-8">
  <div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
    ...
    <div className="grid gap-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0">
      <img src="https://th.bing.com/th/id/OIP.FmoFMeVbPQOWSgw-ighRbAHaEv?pid=ImgDet&rs=1" alt="" className="w-full h-60 object-cover rounded-lg sm:h-52 sm:col-span-2 lg:col-span-full" loading="lazy"/>
      <img src="https://www.theconstructionindex.co.uk/assets/news_articles/2020/06/1592204602_aintee-final-image-low--002-.jpg" alt="" className="hidden w-full h-52 object-cover rounded-lg sm:block sm:col-span-2 md:col-span-1 lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy"/>
      <img src="https://th.bing.com/th/id/R.be2e1d4b372e47ab801eff265f883044?rik=y0pOe4knxy2Oyg&riu=http%3a%2f%2fcaprockhealthsystem.com%2fwp-content%2fuploads%2f2018%2f08%2fHospital-Admission.jpg&ehk=tbGQijNhbDjlPHeRjc1iNlH7wMQiIefMiOeDDPh87ys%3d&risl=&pid=ImgRaw&r=0" alt="" className="hidden w-full h-52 object-cover rounded-lg md:block lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy"/>
    </div>
